...
<a>https://en.wikipedia.org/wiki/Resolution_(mass_spectrometry)</>
...
- [Data-dependent acqusition mode](general-terminology.md#data-dependent-acqusition-mode)
- [Data-independent acquisition mode](general-terminology.md#data-independent-acqusition-mode)
