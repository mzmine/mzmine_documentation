...
The **Ion mobility trace builder** will build [ion mobility traces](ims-background-terminology.md#ion-mobility-traces) from the
...
see [ion mobility traces](ims-background-terminology.md#ion-mobility-traces))
