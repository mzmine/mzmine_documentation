...
build [ion mobility traces](../../workflows/imsworkflow/ims-background-terminology.md#ion-mobility-traces)
...
see [ion mobility traces](../../workflows/imsworkflow/ims-background-terminology.md#ion-mobility-traces))
